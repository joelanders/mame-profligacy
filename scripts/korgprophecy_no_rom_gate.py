...
"""Build and run every redistributable, no-ROM Prophecy publication gate."""
...
def main() -> int:
    ...
    if not args.skip_build:
        run(["./scripts/tms57002test_build.sh"])
        run(["./scripts/korgprophecy_build.sh"])
    for binary in (ROOT / "tms57test", ROOT / "propmin"):
